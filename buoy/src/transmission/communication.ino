...
*/
                ...
                case MAVLINK_MSG_ID_COMMAND_LONG:
                    {
                        // print_debug(CCOMMUNICATION, stdout, CBLUE, 0, "COMMAND_LONG: %d, sequence: %d from component %d of system %d", communication_config.mavlink_msg.msgid, communication_config.mavlink_msg.seq, communication_config.mavlink_msg.compid, communication_config.mavlink_msg.sysid);
                        ...
                        if (mavlink_msg_command_long_get_param1(&(communication_config.mavlink_msg))==MAV_CMD_REQUEST_MESSAGE) {
                            // print_debug(CCOMMUNICATION, stdout, CWHITE, 0, "COMMAND_LONG: %f", mavlink_msg_command_long_get_param1(&(communication_config.mavlink_msg)));
                        } else {
                            print_debug(CCOMMUNICATION, stdout, CWHITE, 0, "COMMAND_LONG: unknown CMD id %d", mavlink_msg_command_long_get_command(&(communication_config.mavlink_msg)));
                        }
                    }
                    break;
                ...
                case MAVLINK_MSG_ID_PARAM_REQUEST_LIST:
                    {
                        ...
                        print_debug(CCOMMUNICATION, stdout, CBLUE, 0, "REQUEST LIST: %d, sequence: %d from component %d of system %d - Sending %f", communication_config.mavlink_msg.msgid, communication_config.mavlink_msg.seq, communication_config.mavlink_msg.compid, communication_config.mavlink_msg.sysid, paramUnion.param_float);
                ...
                default:
                    //Do nothing
                    print_debug(CCOMMUNICATION, stdout, CYELLOW, 0, "MAVLINK Unknown message with ID %d, sequence: %d from component %d of system %d", communication_config.mavlink_msg.msgid, communication_config.mavlink_msg.seq, communication_config.mavlink_msg.compid, communication_config.mavlink_msg.sysid);
            }
        }
