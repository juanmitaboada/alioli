...
#define SERIAL2_CTRLPIN 13          // Serial 2 pin for control the status of the module
#define TRANSMISSION_MS 1000
#define TRANSMISSION_GPS_MS 5000
#define MODEM_SERIAL 1
#define RS485_SERIAL 2
#define MODEM_PIN 2002
#define MODEM_SIMULATED 1
